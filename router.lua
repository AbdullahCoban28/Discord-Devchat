...
function ao.receive()
    -- Dummy implementation of receive function
    -- Replace this with your actual receive logic
    return "Sample message received"
end

function ao.send(message)
    -- Dummy implementation of send function
...
-- Mesaj alımını sürekli dinleyen bir döngü
while true do
